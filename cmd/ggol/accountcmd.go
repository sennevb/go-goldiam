...
var (
	walletCommand = cli.Command{
		...
		Description: `
    ggol wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Goldiam presale wallet",
				ArgsUsage: "<keyFile>",
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    ggol account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    ggol account import [options] <keyfile>
